export class History {
  ...
  reset(state) { this.entries=[]; this.index=-1; this.push(state); }
  push(state) {
  ...
  undo() { return this.canUndo?structuredClone(this.entries[--this.index]):null; }
  redo() { return this.canRedo?structuredClone(this.entries[++this.index]):null; }
}
